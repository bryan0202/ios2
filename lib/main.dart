...
class PaginaInicio extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Bordes en la app de Bryan"),
        centerTitle: true,
      ), //fin appbar
          ...
          child: Column(
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  color: Colors.indigo,
                  image: DecorationImage(image: NetworkImage('https://raw.githubusercontent.com/bryan0202/fotitas/main/184285537_2908258819502405_5450642218410342932_n.jpg'), alignment: Alignment.topCenter),
                  border: Border(
                    top: BorderSide(
                      color: Colors.black,
                      width: 5.0,
